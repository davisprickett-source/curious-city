...
# Upscale minn-4 frames using ffmpeg's lanczos algorithm (high quality)
# This is not AI upscaling but produces sharper results than the original

SOURCE_DIR="/Users/dav/Projects/Curious City/public/sequences/minneapolis/minn-4"
OUTPUT_DIR="/Users/dav/Projects/Curious City/public/sequences/minneapolis/minn-4-upscaled"

echo "Upscaling minn-4 frames with ffmpeg (lanczos)..."
echo ""
...
for frame in "$SOURCE_DIR"/*.jpg; do
  if [ -f "$frame" ]; then
    ...
    # Upscale 2x using lanczos (1280x720 -> 2560x1440 for minn-4)
