...
export const salt_lake_city: CityData = {
  ...
  content: [
    ...
    },
    {
      ...
      url: 'https://www.google.com/maps/search/?api=1&query=Temple%20Square%20(Seagull%20Monument)%20Salt%20Lake%20City',
        ...
        },
        {
          ...
          body: 'In the summer of 1877, workers at the Lake Point resort on the Great Salt Lake reported something terrifying: a massive creature with a crocodile\'s head, a body like a whale, and eyes that glowed in the torchlight. Multiple witnesses claimed sightings over several weeks. Newspapers across the territory erupted with headlines about the "North Shore Monster." One Salt Lake paper offered a $1 million bounty for its capture, which was either a publicity stunt or evidence that 19th-century newspaper editors were even more sensation-hungry than their modern descendants. Local businessmen organized hunting parties. Hotels reported increased bookings from curiosity-seekers. The creature was never caught. One skeptical account, published months later, suggested the monster was actually an extremely large buffalo carcass that had floated into the lake and was bobbing in the waves, its decomposition creating the illusion of movement and its waterlogged hide suggesting scales. This explanation was far less exciting than a genuine lake monster, so it was largely ignored. To this day, the Great Salt Lake occasionally produces "monster" sightings, most of which are attributed to floating debris, weird light conditions, or enthusiastic imaginations. But the 1877 hysteria remains the most documented, and the most commercially successful, monster panic in Utah history.',
          year: '1877',
          image: {
    ...
    },
    {
      id: 'slc-iconic-spots',
      type: 'section',
      title: 'Temple Square & Beyond',
      teaser: 'These are the anchors of SLC identity—the places that define why people settle here and how they thrive in the shadow of the Wasatch Range. From the historic square to the sprawling state fairgrounds, these are the non-negotiables.',
      intro: 'There are things you simply have to see to understand the scale of what happened here. These are the landmarks that define the valley\'s silhouette and its social soul.',
      items: [
        {
          id: 'iconic-1',
          type: 'iconic-spot',
          name: 'Spiral Jetty',
          category: 'Land Art',
          description: 'Robert Smithson\'s 1970 masterpiece is a 1,500-foot coil of black basalt rocks and salt crystals jutting into the Great Salt Lake. It is a monument to entropy and the scale of the landscape.',
          images: [
            {
          ...
          coordinates: { lat: 41.4378, lng: -112.6688 },
          hours: 'Dawn to dusk',
          price: 'Free',
        ...
        },
        {
          ...
          category: 'Nature',
          description: 'A 30,000-acre expanse of hard, white salt crust so flat you can see the curvature of the Earth. Famous for land speed records and otherworldly photography.',
          images: [
            {
          ...
          coordinates: { lat: 40.7600, lng: -113.8963 },
          hours: '24 hours',
          price: 'Free',
        ...
        },
        {
          ...
          description: 'Operated by the University of Utah, this 100-acre botanical garden and arboretum sits in the foothills of the Wasatch Range. Features theme gardens and hiking trails.',
          images: [
            {
          ...
          coordinates: { lat: 40.7667, lng: -111.8242 },
        ...
        },
        {
          ...
          description: 'The spot where Brigham Young first saw the Salt Lake Valley and declared it the home for Mormon pioneers. Features a heritage village and monument.',
          images: [
            {
          ...
          coordinates: { lat: 40.7525, lng: -111.8150 },
        ...
        },
        {
          ...
          category: 'Public Art',
          description: 'A small, quirky park hidden in a residential neighborhood featuring 12 original sculptures and over 70 engraved stones. The most famous is a Sphinx with Joseph Smith\'s head.',
          images: [
            {
          ...
          coordinates: { lat: 40.7583, lng: -111.8694 },
          hours: '8am-8pm daily',
          price: 'Free',
    ...
    },
    {
      ...
      teaser: 'SLC’s real soul isn’t found on the tourist drags; it’s hidden in basement speakeasies, abandoned theaters, and the secret corners of the mountains that the brochures forget.',
      ...
      items: [
        ...
        },
        {
          ...
          category: 'Bookstore',
          description: 'Ken Sanders was Edward Abbey’s close friend and literary executor, which explains why this shop feels more like a desert anarchist’s headquarters than a bookstore. Crammed into a space where the aisles are barely shoulder-width and the stacks reach for the heavens, it is a defiant monument to "Old Salt Lake." Sanders specializes in the rare, the radical, and the Western—Americana, Mormon history, and the kind of Colorado River exploration maps that predate statehood. Sanders himself is often holding court, telling stories of Abbey and the desert that developers are currently erasing. It is a place for serious collectors and those who believe that a city is only as good as its archives.',
          images: [
            {
      ...
      spots: [
        {
          ...
          why: 'Bar X is what happens when serious bartenders open a bar in a city with absurd liquor laws and a reputation for not drinking—they ignore the reputation and work around the laws with creativity that borders on spite. The space is a converted 1930s auto dealership, and the Art Deco elegance feels earned rather than manufactured because it actually is: exposed brick, vintage fixtures, and a layout that respects the building\'s bones. They built Salt Lake\'s modern cocktail culture almost single-handedly, training an entire generation of bartenders who went on to open their own spots across the city. The classics are executed with precision—stirred drinks especially, which require patience and technique most bars don\'t bother with. The original creations respect their foundations while pushing in interesting directions. This is where Salt Lake learned to drink properly, and it remains the gold standard for what a serious cocktail bar should be.',
        ...
        },
        {
          ...
          why: 'Twilite Lounge has been pouring stiff drinks in downtown Salt Lake since 1947, making it older than the interstate highway system, older than Hawaii\'s statehood, and significantly more reliable than either. This is the city\'s definitive "no-bullshit" zone—a wood-paneled timewarp where the jukebox is heavy on classic soul and R&B, the booths have absorbed seven decades of stories, and the bartenders have seen absolutely everything twice. While luxury glass towers sprout like weeds on the surrounding blocks and craft cocktail bars multiply downtown, Twilite remains stubbornly unreconstructed. No $16 cocktails. No "curated" vintage aesthetics. No credit cards—cash is still the only way to pay, which is both inconvenient and exactly the point. The jukebox selection rewards seekers of classic soul. The drinks are strong and cheap. The vibe is timeless in the way only genuine dive bars can achieve. Go for the cheap beer, stay for the absolute lack of pretense, return because nothing else in Salt Lake feels this real.',
      ...
      spots: [
        {
          ...
          why: 'Perched on the edge of Capitol Hill, this is the "anti-office." While other shops emphasize efficiency, Café on 1st feels like the living room of a well-traveled eccentric. It\'s where local musicians, state legislators, and neighborhood characters collide over some of the city\'s best breakfast burritos. There is a specific kind of cozy chaos here—mismatched furniture and local art—that serves as a necessary antidote to the sterile glass towers of downtown just a few blocks away.',
        ...
        },
        {
          ...
          why: 'Blue Copper is a roaster\'s roaster. Operating out of the Central Ninth district, they\'ve spent a decade refining an obsession with the science of the pull. The space is a masterclass in modern design—all crisp lines and natural light—but the real draw is the consistency. They were among the first to bring a truly coastal espresso standard to the valley, proving that you don\'t need a rainy climate to produce world-class light roasts. It is the thinking person\'s coffee shop.',
      ...
      spots: [
        {
          ...
          why: 'Red Iguana is less of a restaurant and more of a regional institution. Since 1985, the Cardenas family has been providing a "baptism by sauce" via their legendary seven mole sauces—the primary reason people drive across the valley to queue up on North Temple. This is a complex, chocolatey, nutty, and spicy exploration of Oaxacan tradition that has drawn everyone from neighborhood regulars to Guy Fieri. The lines are perennial because the quality is unwavering; even after a major fire and the expansion to multiple locations, the original spot remains the undisputed heavyweight champion of Salt Lake dining. The Mole Sampler is the only way to experience the full spectrum of their technical mastery, ranging from the bright Mole Amarillo to the deep, obsidian Mole Negro.',
        ...
        },
        {
          ...
          why: 'HSL (Handle, Salt, Local) is the restaurant that proved Salt Lake could do farm-to-table without the clichés. They don\'t just "work with farms;" they build menus around the specific, often brutal realities of Utah\'s high-desert growing season. The space is a masterclass in organic modernism, but the food is the real story—a technical, produce-forward approach that earned it a permanent spot in the national conversation. It is where you go to taste the actual dirt and sun of the Wasatch Front, refined through an elite kitchen.',
        ...
        },
        {
          ...
          why: 'Pretty Bird is what happens when a chef trained at Le Bernardin decides to perfect the humble chicken sandwich. Viet Pham famously beat Bobby Flay on Iron Chef, and he brings that same competitive technicality to Nashville Hot Chicken. The "Pretty Hot" level isn\'t just heat for heat\'s sake; it\'s a carefully balanced profile of spices that will clear your sinuses while making you wonder how a thigh can be that juicy. It is fast-food elevated to the level of high art.',
        ...
        },
        {
          ...
          why: 'Takashi is an improbable miracle: world-class sushi in a landlocked desert. Chef Takashi Gibo defies geography by flying fish in daily from Tsukiji and Hawaii, but it\'s the technical execution that earned it a standing invitation to the James Beard house. The omakase is a masterclass in restraint and surprise, rivaling anything you\'d find in Tokyo or Los Angeles. It is the restaurant that locals use to win arguments about Salt Lake\'s culinary relevance—a place where the hamachi can change your worldview and the wait for a table is a necessary price for admission.',
      ...
      spots: [
        {
          ...
          why: 'The Rose Establishment sits in the bones of a 1918 meatpacking plant, and the space still hums with the energy of a place where things are built to last. It is a soul-stirring landmark in the Pierpont district where the coffee is treated with a reverence usually reserved for fine wine. Their "Standard"—a shot of espresso, a side of bourbon-infused cocoa, and a glass of sparkling water—is a local ritual that has sustained the city\'s creative class for a decade. With its high ceilings and industrial patina, it remains the definitive hideout for thinkers and makers who require exceptional caffeine to fuel their work.',
        ...
        },
        {
          ...
          why: 'While their multiple locations serve as community hubs, Publik\'s soul resides in their 13,000 sq ft solar-powered roastery—a transformed 1940s printing press that now serves as a cathedral for the bean. They exemplify the third wave of coffee: education, honesty, and an almost religious exaltation of sourcing. The tagline "Quality over Quantity" applies to the people as much as the pour-overs; they explicitly welcome activists and artists, using the massive industrial space to host the conversations that shape the city. It is the definitive specialty roaster for those who want their caffeine with a side of conscience.',
        ...
        },
        {
          ...
          why: 'Caffe d\'Bolla is less of a café and more of a laboratory. John and Yuka Piquet take "origin" to an almost obsessive extreme, sourcing from micro-lots and small farms that most roasters can\'t even find on a map. They brew primarily via siphon—a theatrical, vacuum-pressurized process that produces a cup closer to a fine tea in its complexity. If you want to understand the true potential of a coffee bean, this is your classroom.',
