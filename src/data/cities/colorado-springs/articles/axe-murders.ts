...
export const axeMurders: Article = {
  ...
  featuredImage: {
    ...
    caption: 'Colorado Springs, where the 1911 axe murders shocked the growing resort town',
  ...
  formats: {
    longform: {
      ...
      blocks: [
        ...
        {
          type: 'image',
          src: 'https://upload.wikimedia.org/wikipedia/commons/5/57/Colorado_Springs_Pioneers_Museum_by_David_Shankbone.jpg',
          alt: 'Colorado Springs Pioneers Museum, a historic courthouse building from the early 1900s',
          caption: 'Historic Colorado Springs at the turn of the century was a growing resort town. Many of the homes in the West Dale and Harrison Place neighborhoods were modest Victorian structures where families like the Burnhams and Waynes made their homes.',
          credit: 'David Shankbone / Wikimedia Commons',
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'image',
          src: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/Siekiera.png',
          alt: 'Diagram of an axe showing its parts: handle and metal head with blade and poll',
          caption: 'The murder weapon was a common splitting axe. The killer struck each victim with the blunt poll (back end) rather than the blade—a signature that would later help researchers connect the crime to a series of similar murders across the Midwest.',
          credit: 'Gerhard Elsner / Wikimedia Commons',
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'image',
          src: 'https://upload.wikimedia.org/wikipedia/commons/6/63/Nantucket_Railroad%2C_c._1900s.jpg',
          alt: 'Steam locomotive and railroad train from the early 1900s',
          caption: 'The killer is believed to have ridden the rails, traveling from town to town by freight train and striking in homes located near the tracks. The railroad was both his transportation and his hunting ground.',
          credit: 'Nantucket Historical Association / Wikimedia Commons',
        },
        {
          type: 'paragraph',
