    ...
    content: [
      ...
      },
      {
        ...
        spots: [
          ...
          // REMOVED: Dashi is in Durham, not Raleigh (415 E Chapel Hill St, Durham, NC 27701)
          {
            name: 'Stanbury',
          ...
          },
          {
            ...
            vibe: 'Neighborhood restaurant from a James Beard-nominated chef. Seasonal, product-driven, unpretentious.',
            order: 'The manchego herb biscuits are non-negotiable. Whatever protein they\'re running that night. Trust the kitchen.',
            why: 'Chef Scott Crawford — a Michelin-recognized chef who could be doing fine dining anywhere — chose to open a casual neighborhood spot on Person Street instead. The menu is short and changes constantly because Crawford only cooks what\'s good right now. Every shot is weighed, every ingredient purposeful. This is what happens when a chef with serious credentials decides to cook for the neighborhood instead of critics.',
