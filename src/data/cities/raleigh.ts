      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            yearsOpen: '2013–2020',
            description: 'Galaga, cheap PBR, and live music upstairs. For seven glorious years, Kings was where Raleigh\'s creative class proved the city could have fun without a venture capital pitch deck. Vintage arcade cabinets lined the walls. The beer was cold. Nobody took themselves too seriously. Then the pandemic took it.',
            whyMissed: 'You could be weird here. You could lose at Street Fighter and win at being yourself. Kings was proof that Raleigh\'s soul wasn\'t just office parks and research triangles. When it closed, downtown lost its permission to be unpretentious.',
          ...
          },
          {
            ...
            neighborhood: 'Raleigh',
            yearsOpen: '2010–2016',
            description: 'A strip mall venue that hosted punk, metal, and hardcore shows loud enough to prove Raleigh had teeth. For six sweaty years, Volume 11 gave local bands a stage and all-ages kids a place to scream. When it closed in 2016, the underground went deeper underground.',
            whyMissed: 'The all-ages shows that saved high schoolers from suburban boredom. The commitment to music too heavy for polite company. The knowledge that real bands—touring bands, bands that mattered—played this room. Volume 11 was proof Raleigh wasn\'t all politeness and research parks.',
