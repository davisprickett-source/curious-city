    ...
    },
    {
      ...
      spots: [
        ...
        },
        {
          ...
          why: 'Multnomah Whiskey Library treats spirits with the reverence usually reserved for rare books, which makes sense given the vintage library setting—brick walls, leather chairs, dim lighting, and over 1,500 whiskey labels organized like a bibliography. This isn\'t a bar you stumble into; it\'s a destination you plan for. Non-members can get reservations for $25 per person, which is less cover charge and more down payment on an education. Members skip the line entirely and get access to exclusive bottles that aren\'t available to the general public. The membership waitlist is three years long, which tells you everything about demand and nothing about patience. The Old Fashioned is considered Portland\'s best, which is a bold claim in a city that takes its cocktails seriously, but the bartenders have 1,500 options to work with. Their sister bar, MWL Green Room, offers a more casual overflow option for when you want whiskey without the ceremony. This is drinking as pilgrimage, and people keep making the trip.',
        ...
        },
        {
          ...
          why: 'The Horse Brass opened in 1976 when Don Younger decided Portland needed an English pub that actually took beer seriously. He became the godfather of Portland\'s craft beer revolution—not through marketing or hype, but by curating 50+ taps with the kind of obsessive standards that brewers respected and beer nerds worshipped. The pub is dark in the way proper English pubs are dark: low lighting, scarred wooden tables, and an atmosphere that smells of fried fish and historical significance. Younger famously said "light" is a description for a lamp, not a beverage, which gives you a sense of his philosophy. He died in 2011, but the Horse Brass continues as his legacy—still the meeting ground for brewers, still the pilgrimage site for anyone who cares about hops, still serving fish and chips that pair perfectly with a proper pint of Younger\'s Special Bitter. This is where Portland\'s craft beer scene was born, and it refuses to forget its roots.',
    ...
    },
    {
      ...
      url: 'https://www.google.com/maps/search/?api=1&query=Old%20Town%20Chinatown%20(underground)%20Portland',
        ...
        },
        {
          ...
          featuredOrder: 2,
          category: 'disaster',
          essaySlug: 'the-dream-of-the-nineties',
