      ...
      },
      {
        ...
        spots: [
          ...
          },
          {
            name: 'Columbia Restaurant',
            neighborhood: 'Ybor City',
            vibe: 'The oldest Spanish restaurant in America, operating since 1905 in a stunning hand-painted tile dining room.',
            order: 'The 1905 Salad (prepared tableside), Cuban bread, and the original Cuban sandwich. Finish with their legendary flan.',
            why: 'Columbia isn\'t just a restaurant — it\'s a museum you can eat in. Founded by Cuban immigrant Casimiro Hernandez Sr. in 1905 as a 60-seat corner cafe for Ybor\'s cigar workers, it now spans an entire city block with 15 dining rooms. The hand-painted tiles, wrought iron chandeliers, and stained glass transport you to old Havana. The 1905 Salad has been made the same way for over a century — tossed tableside with garlic, olive oil, and that secret dressing. Flamenco shows run nightly in the main dining room. It\'s touristy and unapologetic about it, but Columbia has earned its legend.',
            address: '2117 E 7th Ave, Tampa, FL 33605',
          ...
          },
          {
            name: 'Datz',
            neighborhood: 'South Tampa',
            vibe: 'Comfort food maximalism — bacon flights, over-the-top burgers, and a deli case that doesn\'t quit.',
            order: 'The Cheesy Todd (grilled cheese stuffed with bacon and fried), truffle fries, and whatever ridiculous burger special they\'re running.',
            why: 'Datz is what happens when someone decides that restraint is overrated. The menu is aggressively indulgent: bacon flights featuring five different preparations, burgers stacked with things that probably shouldn\'t be stacked, mac and cheese elevated to art form. But it works because the execution is genuinely good. The adjacent Datz Dough bakery supplies fresh bread, and the craft beer selection is serious. It\'s loud, it\'s packed, it\'s exactly what you want when you\'ve decided calories don\'t exist.',
            address: '2616 S MacDill Ave, Tampa, FL 33629',
            coordinates: { lat: 27.9186, lng: -82.4941 },
            price: '$$',
            website: 'https://datztampa.com/',
            instagram: '@datztampa',
            hours: 'Mon-Thu 11am-10pm, Fri-Sat 11am-11pm, Sun 10am-9pm',
            images: [
              { src: '/Tampa/restaurants/datz-1.png', alt: 'Datz comfort food spread' },
              { src: '/Tampa/restaurants/datz-2.png', alt: 'Datz bacon flight' },
              { src: '/Tampa/restaurants/datz-3.png', alt: 'Datz South Tampa exterior' },
            ],
          },
          {
            name: 'The Refinery',
            neighborhood: 'Seminole Heights',
            vibe: 'Farm-to-table before it was a buzzword, in the neighborhood that started Tampa\'s food renaissance.',
            order: 'The menu changes constantly based on what\'s local. Trust the chef\'s creativity.',
            why: 'Chef Greg Baker opened The Refinery in 2010 when Seminole Heights was still sketchy and "farm-to-table" was just gaining traction. The restaurant helped transform the neighborhood into Tampa\'s culinary destination. The menu changes daily — sometimes mid-service — based on what local farmers deliver. There\'s no pretension, just honest cooking with excellent ingredients in a converted gas station. It\'s the kind of place where you eat whatever they\'re making and leave grateful.',
            address: '5137 N Florida Ave, Tampa, FL 33603',
            coordinates: { lat: 27.9889, lng: -82.4588 },
            price: '$$',
            website: 'https://www.therefinerytampa.com/',
            instagram: '@therefinerytampa',
            hours: 'Tue-Thu 5pm-10pm, Fri-Sat 5pm-11pm, closed Sun-Mon',
            images: [
              { src: '/Tampa/restaurants/refinery-1.png', alt: 'The Refinery Seminole Heights' },
              { src: '/Tampa/restaurants/refinery-2.png', alt: 'The Refinery seasonal dish' },
              { src: '/Tampa/restaurants/refinery-3.png', alt: 'The Refinery chef at work' },
            ],
          },
        ],
      },
