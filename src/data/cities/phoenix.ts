...
export const phoenix: CityData = {
  ...
  content: [
    ...
    },
    {
      id: 'phx-iconic-spots',
      type: 'section',
      title: 'Desert Foundations',
      intro: 'These are the markers of Phoenix identity—the places that define why people settle here and how they thrive in the sun. From the red rocks of Papago to the neon of Central Avenue, these are the non-negotiables.',
      items: [
        {
        ...
        },
        {
          ...
          category: 'Museum',
          description:
            'Founded in 1929 by Dwight and Maie Heard, this is a world-class temple to Indigenous art and sovereignty. While the pottery and textiles are stunning, the heart of the museum is "The Boarding School Experience"—a gut-punch exhibit documenting the federal government’s attempt to "kill the Indian, save the man." It is essential, sobering viewing that transforms the rest of the museum’s beauty into an act of survival. Every February, the museum hosts the World Championship Hoop Dance Contest, where history and gravity are simultaneously defied.',
          images: [
            {
    ...
    },
    {
      id: 'phx-hidden-gems',
      type: 'section',
      title: 'Beyond the Sun-Bleached Pavement',
      teaser: 'Castles, cemeteries, speakeasies, and secrets hiding in the desert sun',
      intro: 'Phoenix has a reputation for being all about the sprawl, but the real soul of the city is often tucked away in mid-century basements, desert preserves, and strip malls that harbor world-class curiosities.',
      items: [
        {
      ...
      spots: [
        {
          ...
          why: 'Valley Bar exists because Charlie Levy, who opened Crescent Ballroom in 2011, kept noticing a locked "B" button in his office building\'s elevator. One day he asked the landlord what was down there. "Storage, mostly junk," the landlord said. Levy proposed turning 8,000 square feet of forgotten basement into a music venue and lounge. The landlord agreed, and Valley Bar opened in 2015 as Phoenix\'s best answer to a question nobody asked: why don\'t we have basement bars in the desert? Patch & Clark Design created a space that feels like it\'s been there for decades—soft yellows, cool greys, vintage furniture—despite being carved out of what was basically a concrete dungeon. The building\'s history runs deep: Bickoff\'s Deli operated here, art galleries came and went, and music venues hosted Soundgarden, Green Day, and Bad Brains before anyone knew who they were. Now Valley Bar carries that legacy forward with skee-ball, pool tables, pinball machines, and an intimate music venue that books acts you\'ll brag about seeing. It\'s rare, it\'s weird, and it\'s exactly what Phoenix needed.',
        ...
        },
        {
          ...
          why: 'Ross Simon trained at London\'s Lab Bar, moved to Phoenix, and opened Bitter & Twisted on May 30, 2014, in the historic Luhrs Building—a 10-story brick and stone structure completed in 1924. The location carries delicious irony: this building housed Arizona\'s Prohibition enforcement office, where officers dutifully poured confiscated alcohol down the drains while an enterprising janitor rigged collection systems underneath and sold the "dumped" liquor out the back. Nearly a century later, Simon opened a 160-seat cocktail parlor in the same space, serving some of the most technically impressive drinks in the Southwest. The accolades followed: first Arizona bar nominated for Tales of Cocktail\'s "Best American High Volume Cocktail Bar," Top 10 "World\'s Best Cocktail Menu" in 2024, #44 on North America\'s 50 Best Bars in 2022. Simon founded the Arizona chapter of the United States Bartenders\' Guild, launched Arizona Cocktail Weekend, and recently created a first-of-its-kind global cocktail membership club. Nearly half the menu can be made non-alcoholic—a rarity for serious cocktail bars. The ice is hand-carved. The technique is flawless. The building\'s bootlegging past would be proud.',
        ...
        },
        {
          ...
          vibe: 'A massive 1928 warehouse featuring a boxing ring, a vintage streamliner serving sliders, and enough hula hoops to break a world record.',
          order: 'The sliders from the vintage Streamliner and their signature "Old School" cocktail.',
          why: 'Stepping into The Duce is like entering a 1920s carnival held in a grocery terminal. It\'s a 19,000-square-foot adult playground where you can box, hula hoop, or play shuffleboard while drinking craft cocktails. The food comes out of a 1965 Streamliner trailer parked inside the building. It\'s loud, chaotic, and unapologetically Phoenix—a defiant use of industrial space that feels like a secret club for everyone.',
          address: '525 S Central Ave, Phoenix, AZ 85004',
          coordinates: { lat: 33.4435, lng: -112.0739 },
          price: '$$',
        ...
        },
        {
          ...
          vibe: 'A subterranean speakeasy in a former ostrich feather storage room from the early 1900s.',
          order: 'Whatever the bartender suggests — the craft cocktails are the focus.',
          why: 'Descend the red-lit staircase and step into one of the Valley\'s most atmospheric bars. The space once stored ostrich feathers during Chandler\'s ostrich farming heyday. The hidden entrance, either via kitchen-utensil-covered door from the restaurant above or the exterior staircase, sets the tone for a genuinely underground experience. Authentic history meets modern cocktail craft.',
        ...
        },
        {
          ...
          vibe: 'Phoenix\'s oldest watering hole — a 1946 time capsule with original tiki décor.',
          order: 'A cheap beer and a shot. This is a dive bar, embrace it.',
          why: 'The Bikini Lounge has been pouring drinks since 1946, making it Phoenix\'s oldest bar. The 1940s tiki décor remains mostly intact — a genuine time capsule from post-WWII Phoenix. Located at the crossroads of Roosevelt Row and Grand Avenue, it\'s unassuming from the outside and known mainly to dive bar enthusiasts who appreciate authenticity over ambiance. Cash only.',
