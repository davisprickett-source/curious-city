...
export const dallas: CityData = {
  ...
  content: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Dallas icon. Mary Sparks and Megan Wilkes make Fine Pie for Fine Folk — seasonal handmade pies from scratch with local ingredients. The Drunken Nut (pecan), Lord of the Pies (deep-dish apple with streusel), and Smooth Operator (French silk on pretzel crust) are legendary.',
          images: [
            {
            ...
            {
              src: '/dallas/establishments/emporium-smooth.jpg',
              alt: 'Smooth Operator French silk pie',
            }
          ],
    ...
    },
    {
      ...
      intro: 'In Dallas, coffee is often a high-stakes performance—serious beans, precise extraction, and spaces that feel like modern temples. These aren\'t just caffeine stops; they\'re where the city\'s creative class plots its next move.',
      spots: [
        {
