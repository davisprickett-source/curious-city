...
export const anchorage: CityData = {
  ...
  content: [
    ...
    },
    {
      ...
      teaser: 'Quicksand tidal waves, urban moose combat, and Soviet-occupied guerrillas',
      intro: 'Anchorage is a place where the 21st century is constantly being interrupted by the Ice Age. From 30-foot salmon caught on lunch breaks to the fact that urban moose are statistically more dangerous than grizzlies, the city exists on a knife\'s edge of survival.',
      items: [
        {
          id: 'anc-curiosity-1',
          type: 'curiosity',
    ...
    },
    {
      id: 'iconic-spots',
      type: 'section',
      title: 'Last Frontier Landmarks',
      intro: 'These are the markers of Anchorage identity—the places that define why people settle here and how they thrive. From the shores of Cook Inlet to the peaks of the Chugach Range, these are the non-negotiables.',
      items: [
        {
          id: 'iconic-1',
          type: 'iconic-spot',
    ...
    },
    {
      ...
      spots: [
        ...
        },
        {
          ...
          neighborhood: 'Downtown',
          vibe: 'A massive, high-ceilinged temple to Alaska craft beer with a rooftop deck that actually catches the sun.',
          order: 'The "Solstice" IPA and the yak burger.',
          why: 'Yes, there is a replica of the "Into the Wild" bus on the roof for the tourists, but 49th State earns its keep with a deep tap list and some of the best rooftop views in the city. It’s where you go when you want to feel the scale of Alaska without leaving the comfort of a heated patio. The brewing is technically excellent, and the menu features the kind of game meats—yak, bison—that fulfill the frontier promise.',
        ...
        },
        {
          ...
          neighborhood: 'Downtown',
          vibe: 'Sophisticated rustic-industrial vibe with a massive fireplace as the central hearth.',
          order: 'The Peanut Butter Porter and the alder-wood grilled rotisserie chicken.',
          why: 'Glacier Brewhouse is the "grown-up" version of the Alaska brewpub. It’s loud, warm, and perpetually busy, built around a massive open kitchen and a wood-fired grill. It manages to be both a power-lunch spot for city officials and a cozy retreat for travelers shaking off the chill. Their Peanut Butter Porter has a cult following for a reason—it’s thick, dark, and dangerously drinkable.',
          address: '737 W 5th Ave, Anchorage, AK 99501',
          coordinates: { lat: 61.2176, lng: -149.8943 },
          price: '$$$',
    ...
    },
    {
      ...
      spots: [
        ...
        },
        {
          ...
          vibe: 'A vibrant, sticker-covered cultural landmark that happens to be one of the highest-grossing independent pizzerias in America.',
          order: 'The Santa\'s Little Helper or the Avalanche pizza, with a Fairweather IPA.',
          why: 'Moose\'s Tooth is more than a restaurant; it\'s the collective living room of Anchorage. It routinely ranks as one of the top two or three highest-grossing independent pizzerias in the United States, which is staggering given it\'s in a city of 300,000. People wait two hours in sub-zero temps for these pies because the flavor combinations are fearless and the house-brewed beer (Broken Tooth) is world-class. If you haven\'t been here, you haven\'t been to Anchorage.',
        ...
        },
        {
          name: 'Snow City Cafe',
          neighborhood: 'Downtown',
          vibe: 'Upbeat, colorful, and perennially packed breakfast hub.',
          order: 'The "Tundra" omelet with reindeer sausage.',
          why: 'Snow City is the great equalizer of Anchorage. On any given morning, you\'ll find the Governor sitting at a table next to a group of bearded commercial fishermen. It achieved national fame when President Obama stopped in and bought out their entire supply of pumpkin muffins in 2015, but locals loved it long before that. The menu is a love letter to the Alaskan breakfast, featuring reindeer sausage, local seafood, and the kind of coffee service that makes the long winters bearable.',
    ...
    },
    {
      ...
      intro: 'When the sun disappears for 19 hours a day, caffeine is the only thing keeping the city sane. Anchorage roasters take their job seriously, offering high-extraction sanctuary from the sub-zero wind chill.',
      spots: [
        {
...

    {
      ...
      teaser: 'Fly by Night Club, Marx Bros. Cafe, and the Alaska legends that closed',
