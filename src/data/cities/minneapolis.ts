      ...
      spots: [
        {
          ...
          neighborhood: 'Uptown',
          vibe: 'A basement speakeasy where the Prohibition-era fantasy is fully realized. Velvet curtains, amber light, and the ghost of a hidden city.',
          ...
          why: 'Finding Volstead’s is a ritual in urban detective work. You step behind the Up-Down arcade, navigate a nondescript alley, and look for a door with a tiny sliding window—the kind that requires a subtle nod to enter. Inside, the 1920s aesthetic is absolute: velvet-draped booths, low-slung amber lighting, and a stage where live jazz musicians compete with the rattle of cocktail shakers. The bartenders here are technicians, specializing in a "dealer’s choice" program that transforms vague flavor preferences into precise liquid epiphanies. It is one of the few places where the food isn’t an afterthought—the deviled eggs have a local cult following—and the atmosphere is so thick you half expect to see a federal agent at the bar. It is the definitive Minneapolis speakeasy, executed by people who treat the past with reverence.',
        ...
        },
        {
          ...
          vibe: 'Drink in Wilbur Foshay’s 27th-floor private penthouse. Gilded Art Deco details and views that stretch to the horizon.',
          order: 'A classic Old Fashioned while watching the sun set over the Minneapolis skyline. Save room for a nightcap.',
          why: 'Prohibition is located in the literal apex of Minneapolis history—the private penthouse of Wilbur Foshay, the man who built this tower as a monument to his own ambition just before the 1929 stock market crash led him to federal prison. The space is a preservationist’s dream, retaining the original mahogany, gold leaf, and Art Deco geometry from the 1920s. Perched 27 floors above Marquette Avenue, it offers panoramic views that turn the city into a grid of shimmering lights. The cocktails lean classic, designed to be sipped while contemplating the irony of drinking in a space built by a man who went to prison for fraud. It is a hauntingly beautiful reminder of the city’s boom-and-bust cycle, served with one of the best Old Fashioneds in the Midwest.',
          ...
          images: [
            ...
            {
              src: 'https://lh3.googleusercontent.com/gps-cs-s/AG0ilSzlw7MtJrM_glYCIXsn6xqO_JUs_dJ3RKlt8OkT8FqA4-S3uDJnws0uBXAGL5KYnVZm5MtzQd4DI8wp8T72NunhduKKU1Dr6B_-5p_lWtGj-ggGP1_oFF8jdgovDdsGnP1TtetUAA=w3427-h1887-k-no',
      ...
      spots: [
        {
          ...
          why: 'Huge space, abundant outlets, and a staff that genuinely doesn’t mind if you camp for four hours. It is the "anti-office" for the Highland Park crowd—spiritually perfect for anyone who needs to solve a complex coding problem or finally finish that screenplay without the passive-aggressive side-eye of a 90-minute laptop limit.',
        ...
        },
        {
          ...
          why: 'Five Watt is third-wave coffee with a sense of humor. The "Kingfield Spritz" (espresso, tonic, grapefruit) is a local rite of passage—a drink that sounds like a mistake but tastes like an epiphany. It is a neighborhood hub where the baristas treat the espresso machine like a high-performance engine and the customers like human beings.',
        ...
        },
        {
          ...
          why: 'Operating out of a converted industrial hole-in-the-wall, Misfit is where the Northeast remote-work crowd hides from the influencers. It has an unpolished, neighborhood-bar energy that favors productivity over "vibes." The lighting is natural, the pace is human, and the cold press is strong enough to power a small aircraft.',
    ...
    },
    {
      ...
      spots: [
        ...
        },
        {
          ...
          vibe: 'The neon-lit birthplace of the Jucy Lucy. A no-frills dive bar where the grill is seasoned by seventy years of beef and legend.',
