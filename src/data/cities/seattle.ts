    ...
    },
    {
      ...
      spots: [
        ...
        },
        {
          ...
          vibe: 'The Amazon-adjacent rooftop with the best skyline views in the city.',
          order: 'Whatever cocktail suits the sunset. The drinks are solid; the view is the point.',
          why: 'Mbar sits atop the M building in South Lake Union, surrounded by Amazon\'s expanding campus. The rooftop patio offers 360-degree views — Space Needle, downtown, Lake Union, distant mountains on clear days. The cocktails are better than they need to be for a view bar. It gets busy with tech workers after 5pm, but the sunset hour is worth fighting for.',
          address: '2108 Western Ave, Seattle, WA 98121',
          coordinates: { lat: 47.6128, lng: -122.3458 },
          hours: '4pm-11pm Mon-Thu, 4pm-midnight Fri-Sat, 4pm-10pm Sun',
          price: '$$$',
          website: 'https://www.mbarseattle.com',
          images: [],
        },
        {
          name: 'The Hideout',
          neighborhood: 'First Hill',
          vibe: 'Punk-rock dive with pinball, cheap beer, and a jukebox that actually matters.',
          order: 'Rainier tallboy. Don\'t overthink it.',
          why: 'Seattle has plenty of "dive bars" that are actually hipster-curated recreations. The Hideout is the real thing — sticky floors, pool table, punk flyers on the walls, and a crowd that includes nurses from nearby hospitals, musicians between sets, and anyone else who wants a drink without pretense. The jukebox is excellent. The pinball machines work. The vibe is perfect.',
    ...
    },
    {
      ...
      spots: [
        ...
        },
        {
          ...
          price: '$$',
          website: 'https://www.maneki-seattle.com',
          images: [],
        },
        {
          name: 'Un Bien',
        ...
        },
        {
          ...
          coordinates: { lat: 47.5986, lng: -122.3247 },
          hours: '8am-8pm daily',
          price: '$',
          website: 'https://www.phobac.com',
          images: [],
        },
        {
          name: 'Eden Hill',
          neighborhood: 'Queen Anne',
          vibe: 'A 12-seat tasting menu in a converted house. Intimate, surprising, and worth the splurge.',
          order: 'There\'s only the tasting menu. That\'s the point.',
          why: 'Eden Hill serves a multi-course tasting menu in a tiny space that seats 12. Chef Maximillian Petty cooks alone in an open kitchen, creating dishes that blend Pacific Northwest ingredients with global technique. It\'s not cheap, but it\'s one of the most personal dining experiences in Seattle — like being invited to a particularly talented friend\'s dinner party.',
          address: '2209 Queen Anne Ave N, Seattle, WA 98109',
          coordinates: { lat: 47.6385, lng: -122.3568 },
          hours: '5pm-9pm Wed-Sun',
          price: '$$$$',
          website: 'https://www.edenhillrestaurant.com',
          images: [],
        },
      ],
    },
      ...
      items: [
          ...
          sources: [
            {
              ...
              year: '2008',
              url: 'https://www.seattletimes.com/seattle-news/the-wah-mee-massacre/',
            },
            {
              type: 'book',
              title: 'Wah Mee: A True Seattle Crime Story',
              author: 'Various',
              year: '2018',
            }
          ],
          ...
          sources: [
            {
              ...
              publisher: 'Seattle Times',
              year: '2011',
              url: 'https://www.seattletimes.com/seattle-news/green-river-killer/',
            }
          ],
          images: [],
        },
        ...
        },
        {
          ...
          sources: [
            {
              type: 'article',
              title: 'The Everett Massacre of 1916',
              publisher: 'HistoryLink',
              year: '2003',
              url: 'https://www.historylink.org/File/5684',
            }
          ],
          images: [],
        },
        {
          ...
          sources: [
            {
              type: 'article',
              title: 'The Capitol Hill Massacre',
              publisher: 'Seattle Times',
              year: '2016',
              url: 'https://www.seattletimes.com/seattle-news/capitol-hill-shooting/',
            }
          ],
          images: [],
        },
          ...
          sources: [
            {
              ...
              publisher: 'HistoryLink',
              year: '2006',
              url: 'https://www.historylink.org/File/7716',
            }
          ],
          images: [],
        },
