...
export const seattle: CityData = {
  ...
  content: [
    ...
    },
    {
      id: 'sea-curiosities',
      type: 'section',
      title: 'Seattle\'s Strange & Remarkable',
      ...
      spots: [
        {
          ...
          why: 'Jamie Boudreau opened Canon in 2011 on Capitol Hill\'s 12th Avenue with the modest goal of running a neighborhood restaurant. His creativity, ego, and competitiveness intervened spectacularly. It became a destination for people worldwide, which is what happens when you build America\'s largest spirits collection—4,000+ labels, including the world\'s largest American whiskey collection. Bottles line the hallways. Bottles line the bathrooms. Over 100 more sit in the basement waiting for their moment. Tales of the Cocktails named it Best Spirits Collection in the World. Food & Wine, Esquire, and Travel & Leisure all declared it among America\'s Best Bars. Drinks International ranked it #6 on the World\'s 50 Best Bars in 2014. James Beard nominations followed. The Captain\'s List contains pre-Prohibition liquids that cost more than used cars—bottles that survived a century to be drunk by people who can afford the privilege. Bartenders navigate the shelving like librarians with advanced degrees in liquid history, translating your vague flavor preferences into precise pours. This is spirits collecting as competitive sport, and Boudreau won.',
        ...
        },
        {
          ...
          why: 'Artist Greg Lundgren and videographer Jeff Scott opened The Hideout on March 24, 2005, in First Hill when First Hill was a social dead zone—hospitals, elderly housing, and nothing to do at night. They called it a "five-year performance piece" to relieve the pressure of long-term commitment and frame it as an art project rather than a business, which was either genius or delusion depending on how you measured it. Twenty years later, it\'s still here, which settles the question. Over 90 regional artists\' work stacks the walls in rotating exhibitions. A vending machine dispenses miniature artworks for $5. Sketchbooks sit on the bar for idle drinkers to fill with thoughts and sketches. The patron-driven "Vital 5 Review" zine documents the scene. Cocktails are crafted with fresh ingredients and actual care by bartenders who treat the craft seriously. This isn\'t a hipster recreation of a neighborhood bar—it\'s the real thing that inspired all the imitations, a 20-year experiment in making a bar function like a culture center that somehow worked.',
