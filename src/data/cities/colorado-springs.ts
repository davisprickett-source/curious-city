    ...
    },
    {
      ...
      spots: [
         ...
         */
        {
          ...
          why: 'In a city built on military precision and evangelical values, The Rabbit Hole is the necessary glitch in the matrix. You enter through what looks like a subway kiosk on the sidewalk and descend into a dim, mural-covered sanctuary for the nocturnal. It’s Alice in Wonderland by way of a gothic industrial club, serving surprisingly high-end New American fare to a crowd that range from date-nighters to off-duty soldiers.',
        ...
        },
        {
          ...
          why: 'Located inside the Ivywild School—a decommissioned primary school turned adult playground—The Principal\'s Office preserves the institutional green tiles and wooden cabinets of its past. The bartenders here are "faculty," the drinks are the "curriculum," and getting sent to this office is the goal, not the punishment. It’s the highest-functioning reuse of a blackboard-era space in the region.',
      ...
      spots: [
        {
          ...
          why: 'Shuga\'s is the cozy, mismatched heart of Colorado Springs. Housed in a tiny historic cottage, it feels like an art-damaged living room where the soup is legendary and the vibe is aggressively friendly. The Coconut Shrimp soup has a cult following that borders on a religion, and the "snack boards" are the perfect excuse to linger under the strings of lights and vintage polaroids.',
