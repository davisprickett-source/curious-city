...
export const chicago: CityData = {
  ...
  content: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'The two bronze lions flanking the Art Institute\'s Michigan Avenue entrance have guarded the museum since 1894, when sculptor Edward Kemeys placed them on their granite pedestals. They\'re massive: each weighs about two tons and stands nearly 10 feet tall. But their real power isn\'t aesthetic; it\'s prophetic. Since the 1920s, Chicagoans have dressed the lions in sports gear before major championship games. Bears helmets. Blackhawks jerseys. Cubs caps. White Sox gear for the skeptics. According to museum lore (and the fans who believe it with almost religious intensity), when the lions wear team colors before a championship game, Chicago wins. The tradition started informally, but the museum eventually formalized it, coordinating with teams on which games merit the treatment. The logistics are genuine: museum staff work with scaffolding and safety protocols to properly outfit two-ton bronze sculptures that weren\'t designed for costume changes. Chicago fans take the prophecy seriously enough to panic when the lions aren\'t dressed and to credit them when the city wins. The lions have now accumulated a better playoff record than several of the actual teams.',
          images: [
            {
        ...
        },
        {
          ...
          body: 'The Old Chicago Main Post Office, completed in 1932, was built directly over Congress Parkway, straddling the road like a giant mail-sorting bridge. It remains the only postal facility in American history where vehicles pass through the building itself. At its peak, the building processed 17 million pieces of mail daily. Mail trucks loaded on upper floors while city traffic flowed through the massive archways below. The building is nine stories tall and covers two city blocks. When the Postal Service moved operations in 1997, the structure sat magnificently vacant for over two decades. Urban explorers sneaked in. Developers circled. The building appeared in films including "The Dark Knight" because it looked apocalyptic. In 2019, a $600 million renovation converted it into what\'s now called "The Old Post Office," a 2.5-million-square-foot commercial space that includes the largest single-floor office plate in America. Uber made it their Chicago headquarters. The conversion is regarded as one of the most significant adaptive reuse projects in the country. The road still runs through the building. Now instead of mail, there\'s just traffic and irony.',
          images: [
            {
      ...
      spots: [
        {
          ...
          why: 'The Whistler is the platonic ideal of the Logan Square creative ethos—part high-concept cocktail bar, part avant-garde performance space, part rotating art gallery, all wrapped in a deliberately anti-corporate aesthetic. It opened in 2008 when Logan Square was still affordable for artists and became a defining space for the neighborhood\'s creative class. The room is small and dimly lit, the cocktail menu is designed like a zine with hand-drawn illustrations, and the seasonal infusions are taken seriously without pretense. Bartenders are technical masters who can explain the chemistry of clarified milk punches but are equally happy to recommend the best late-night taco stand. The back room hosts some of Chicago\'s best experimental jazz and improv programming—artists like Makaya McCraven, Irreversible Entanglements, and the city\'s deep bench of free-jazz musicians treat it as an essential venue. The art on the walls rotates regularly, showcasing local painters, illustrators, and photographers. There\'s a specific intellectual coolness here that manages to avoid pretension: it\'s serious about craft but not about itself. Logan Square has gentrified significantly since The Whistler opened, but it remains a space that values creativity, experimentation, and community over profit margins.',
        ...
        },
        {
          ...
          why: 'Skylark is a Pilsen institution that has remained stubbornly itself even as the neighborhood around it has transformed from a working-class Mexican enclave to a contested zone of galleries and condos where everyone pretends to know what "liminal space" means. It\'s cash-only (yes, still), the pours are strong enough to make you reconsider your third drink, and the jukebox is legitimately one of the best in the city—curated by generations of regulars with impeccable taste in Motown, classic country, and \'70s punk that will shame your Spotify Wrapped. The booths are red vinyl, the lighting is dim enough to hide your bad decisions, and the vibe is "come as you are" in the actual sense, not the corporate branding sense. This is the kind of bar where you walk in alone and leave with new friends or at least some good stories, where artists and construction workers drink side-by-side without anyone making a thing about it, and where the bartenders remember your drink after the second visit because they\'re paying attention. There are no TVs, no cocktail menu, and absolutely no patience for gentrification anxiety. It\'s just a good neighborhood bar that happens to be perfect. If it ever closes, a piece of real Chicago goes with it.',
        ...
        },
        {
          ...
          why: 'Finding Three Dots and a Dash requires navigating an unmarked alley behind a Tex-Mex restaurant on Clark Street, which is entirely intentional—the obscurity filters out tourists looking for Instagram ops and attracts people who understand tiki as a legitimate cocktail tradition. Inside is a maximalist Polynesian fantasy: carved tikis, vintage maritime ephemera, moody tropical lighting, and a rum collection that spans 100+ bottles from Jamaica, Martinique, Guyana, and beyond. The cocktails are elaborate multi-step productions—the signature Three Dots and a Dash involves multiple rums, falernum, honey, lime, and allspice, served in a ceramic tiki mug with a garnish that looks like a tropical explosion. The bartenders take tiki seriously in the way serious bartenders should: they know the history of Donn Beach and Trader Vic, they respect the craft of balance and dilution, and they understand that escapism doesn\'t mean laziness. It\'s not ironic nostalgia—it\'s a genuine homage to mid-century tiki culture executed at a high level. The drinks are strong, the vibe is immersive, and it\'s one of the few places in Chicago where you can temporarily forget you\'re in the Midwest.',
        ...
        },
        {
          ...
          why: 'Maria\'s is what happens when a neighborhood bar becomes a cultural institution through sheer force of curation and conviction. Owner Ed Marszewski—artist, publisher, and Bridgeport evangelist—took over his family\'s corner tavern in 1986 and turned it into the nerve center of Chicago\'s South Side creative scene. The front is a bottle shop with one of the best craft beer selections in the city (200+ bottles, constantly rotating taps). The back is a bar with a kitchen turning out surprisingly good tacos and pub fare. The walls are covered in local art, the crowd is a mix of longtime Polish regulars and younger creatives who moved to Bridgeport because Maria\'s made it feel possible. Marszewski also runs *Lumpen Magazine* and helped launch events like the Bridgeport Art Center open studios—basically, he\'s been instrumental in making Bridgeport one of Chicago\'s most interesting neighborhoods. It\'s cash-only, the Malört is always $3, and the ethos is aggressively anti-corporate. If you want to understand how Chicago\'s neighborhood culture actually works, this is required fieldwork.',
        ...
        },
        {
          ...
          why: 'Simon\'s Tavern is the last physical remnant of Andersonville\'s Swedish-American past, a neighborhood bar that has somehow survived 90 years of urban transformation without compromising its identity or installing a single Edison bulb. It opened in 1934, and the nautical decor—ships\' wheels, maritime flags, wood paneling—is original, not "reclaimed" or "vintage-inspired." The glogg (Swedish mulled wine) they serve every winter has become a Chicago tradition: people line up in December for the spiced, warming concoction that tastes like liquid Christmas and makes you understand why Swedes survive those winters. The rest of the year, it\'s a straightforward neighborhood tavern with cheap beer, a jukebox, and a crowd that spans generations—old Swedes who remember when Andersonville was entirely Scandinavian, younger locals who moved here for the LGBTQ+ community, and everyone in between who just wants a normal bar. There are no craft cocktails, no "concepts," and no attempts to modernize beyond what\'s necessary to keep the doors open and the health inspector happy. It\'s just a good, honest bar with deep roots and a soul that can\'t be replicated by some gastropub consultant. Andersonville has changed almost entirely—the Swedish bakeries are mostly gone, the immigrant generation has aged out—but Simon\'s remains, serving glogg every December like a defiant act of cultural memory. If this bar ever closes, something essential about Chicago\'s immigrant history closes with it.',
    ...
    },
    {
      ...
      intro: 'Chicago didn\'t invent third-wave coffee, but it perfected the blueprint and then refused to shut up about it. Intelligentsia pioneered Direct Trade in a North Broadway warehouse in 1995, fundamentally changing how specialty coffee interacts with global agriculture (and making Seattle look bad in the process). Dark Matter turned bourbon barrels and psychedelic aesthetics into a roasting philosophy that sounds like it shouldn\'t work but absolutely does. The Wormhole put a DeLorean in a cafe and still managed to make the city\'s best vanilla latte, which is peak Chicago energy. What started as a handful of obsessive roasters has evolved into a full ecosystem: James Beard-nominated bakery-cafés run by chefs who trained at Charlie Trotter\'s, neighborhood spots roasting their own beans in Bridgeport and Lakeview like it\'s no big deal, and specialty roasters treating single-origin pour-overs like high-fidelity audio equipment that requires a manual. Chicago\'s coffee scene operates with Midwestern seriousness—technical precision, direct sourcing, zero bullshit, and strong opinions about water temperature—but without the self-importance that plagues coastal cities. These aren\'t Instagram props designed to move merch. They\'re the real thing, and they know it.',
      spots: [
        {
        ...
        },
        {
          ...
          why: 'The Wormhole operates on a simple premise: you can have fun and still make exceptional coffee, and anyone who says otherwise is boring. There is, famously, a full-size DeLorean parked inside the cafe—a *Back to the Future* reference that announces the 80s theme before you even order and immediately separates the people who get it from the people who don\'t. The walls are covered in vintage toys, movie posters, and pop culture ephemera from the Reagan era that would make any Xennial weep with nostalgia. It could easily be a gimmick designed to move Instagram content. Instead, it\'s one of Wicker Park\'s most beloved coffee shops because the fundamentals are rock-solid. They roast their beans locally through Halfwit Coffee, they make all their syrups in-house (the vanilla latte has achieved near-mythic status among Chicago coffee nerds who will fight you about it), and the baristas actually care about extraction and temperature instead of just looking cool. The result is a space that feels like a nostalgic time capsule but tastes like serious third-wave coffee. Regulars will argue—passionately, sometimes loudly—that it serves the best vanilla latte in the city, and they\'re not wrong. It\'s proof that you can embrace kitsch without sacrificing craft, that a coffee shop can be both deeply silly and deeply good. In a neighborhood that has gentrified beyond recognition, The Wormhole remains a rare example of a place that doesn\'t take itself too seriously but takes coffee very seriously indeed.',
        ...
        },
        {
          ...
          why: 'Hexe represents the full vertical integration of the modern specialty coffee shop: they roast their own beans on-site, employ an actual pastry chef who bakes everything from scratch daily, and run seasonal barrel-aging programs that would make a craft brewery jealous. The name means "witch" in German, and the aesthetic leans into a playful, slightly occult vibe—but the coffee is dead serious. The roasting operation is visible from the cafe, which means you can watch green beans transform into the espresso you\'re drinking. The barrel-aged coffees are a particular specialty: beans aged in bourbon, whiskey, or wine barrels that pick up subtle notes of oak, vanilla, and whatever spirit previously inhabited the wood. It\'s experimental without being gimmicky. The pastries aren\'t an afterthought—Hexe has a dedicated pastry chef producing croissants, scones, and seasonal treats that rival actual bakeries. Located on Diversey in Lakeview, the space is bright and welcoming, with floor-to-ceiling windows and a design that signals "we care about this" without being pretentious. It\'s the kind of coffee shop that makes you wish you lived in the neighborhood so you could become a regular.',
