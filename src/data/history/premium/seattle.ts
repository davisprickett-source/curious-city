...
export const seattle_premium_history: Record<string, History> = {
  'rain-city-rising-premium': {
    slug: 'rain-city-rising-premium',
    citySlug: 'seattle',
    ...
    blocks: [
      // Video 1: Overview - city between two bodies of water
      {
        id: 'video1',
        type: 'video-sequence',
        videoPath: '/sequences/seattle/seattle-1',
        scrollHeight: 220,
        textBlocks: [
          {
            id: 'p1',
      ...
      // Video 18: Mountains
      {
        id: 'video18',
        type: 'video-sequence',
        videoPath: '/sequences/seattle/seattle-18',
        scrollHeight: 220,
        textBlocks: [
          {
            id: 'p18',
            type: 'paragraph',
            content: 'The mountains frame everything—the Cascades to the east, the Olympics to the west, Mount Rainier to the south rising 14,411 feet, so large it creates its own weather, visible from a hundred miles away on clear days, the defining landmark of the region. The locals call it "the Mountain" as if there were only one, and on the days when it emerges from the clouds, everyone stops to look, to point, to take photographs that never capture the scale. The city exists in its shadow, built on its volcanic debris, aware at some level that Rainier is not just beautiful but dangerous, an active volcano that could bury communities under mudflows if it decided to wake.',
          },
        ],
      },
      // Video 19: Tech money
      ...
      // Video 20: Conclusion
      {
        id: 'video20',
        type: 'video-sequence',
        videoPath: '/sequences/seattle/seattle-20',
        scrollHeight: 350,
        textBlocks: [
          {
            id: 'p20',
            type: 'paragraph',
            content: 'Seattle persists between the water and the mountains, the rain and the occasional sun, the old industries and the new money, the progressive politics and the resistant neighborhoods, the dream of what it wants to be and the reality of what it has become. The ferries still cross the Sound. The fish still fly at Pike Place. The coffee still pours in shops where people work on laptops, building the next thing, convinced that here, in this gray and green and water-wrapped city, they can make something that matters. The rain falls, and the cranes rise, and the city continues its argument with geography, building higher and denser and more expensive, still believing that the future belongs to whoever is willing to get wet for it.',
          },
        ],
      },
    ],
