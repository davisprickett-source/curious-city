...
export const fargo_premium_history: Record<string, History> = {
  'on-the-bed-of-a-vanished-lake-premium': {
    slug: 'on-the-bed-of-a-vanished-lake-premium',
    citySlug: 'fargo',
    ...
    heroImage: {
      src: '/sequences/fargo/fargo-1/frame_0001.webp',
      alt: 'The flat expanse of Lake Agassiz bed',
      position: 'center',
    },
    premium: {
      isPremium: true,
    ...
    blocks: [
      // Video 1: p1 - Lake Agassiz intro
      {
        id: 'video1',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-1',
        scrollHeight: 200,
        textBlocks: [
          {
            id: 'p1',
      ...
      // Video 2: p2 - Red River
      {
        id: 'video2',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-2',
        scrollHeight: 200,
        textBlocks: [
          {
            id: 'p2',
      ...
      // Video 3: p3 - Name and railroad history
      {
        id: 'video3',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-3',
        scrollHeight: 200,
        textBlocks: [
          {
            id: 'p3',
      ...
      // Video 4: p4 - Winter
      {
        id: 'video4',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-4',
        scrollHeight: 200,
        textBlocks: [
          {
            id: 'break1',
      ...
      // Video 6: p6 - Town growth
      {
        id: 'video6',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-6',
        scrollHeight: 200,
        textBlocks: [
          {
            id: 'sub2',
      ...
      // Video 9: p9 - NDSU
      {
        id: 'video9',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-9',
        scrollHeight: 190,
        textBlocks: [
          {
            id: 'p9',
            type: 'paragraph',
            content: 'North Dakota State University dominates the south side of town, bringing 14,000 students and the football team that wins FCS national championships with regularity that seems almost unfair, the Bison Dynasty, small-school football played with a seriousness that makes the NFL look casual. Game days in fall the stadium fills, the whole city painted green and gold, tailgaters grilling in parking lots while the temperature drops and the season contracts toward winter.',
          },
        ],
      },
      // Video 10: p10 - Downtown murals
      {
        id: 'video10',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-10',
        scrollHeight: 200,
        textBlocks: [
          {
            id: 'p10',
      ...
      // Video 11: p11 - Politics (REVERSED)
      {
        id: 'video11',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-11',
        scrollHeight: 170,
        textBlocks: [
          {
            id: 'break2',
      ...
      // Video 14: p14-p15 - Sky and conclusion (REVERSED)
      {
        id: 'video14',
        type: 'video-sequence',
        videoPath: '/sequences/fargo/fargo-14',
        scrollHeight: 220,
        textBlocks: [
          {
            id: 'p14',
