    ...
    'sunshine-and-hustle': {
      ...
      blocks: [
        ...
        },
        {
          id: 'p3',
          type: 'paragraph',
          content: 'Ybor City made Tampa. In 1885, Vicente Martinez-Ybor moved his cigar manufacturing from Key West—fleeing labor troubles and a fire—to a patch of scrubland east of Tampa, and within a decade the neighborhood was producing 300 million cigars annually, more than Havana. Cuban, Italian, and Spanish workers rolled tobacco by hand at long wooden tables while lectors, paid by the workers themselves, sat on elevated platforms reading Tolstoy and Zola and radical newspapers aloud, the factory floor doubling as a salon. The neighborhood was cosmopolitan in ways the rest of Florida couldn\'t comprehend: mutual aid societies for each ethnic group, social clubs with marble staircases, labor organizing that made the factory owners nervous, anarchist and socialist politics debated openly in coffee shops and on street corners. By 1900, Ybor City was producing cigars worth $25 million annually—the largest cigar-manufacturing center in the world.',
        },
        {
          id: 'quote1',
          type: 'pullquote',
          content: 'Miami has Art Deco and celebrity; Tampa has strip clubs and strip malls and a working port.',
        },
        {
          id: 'p4',
          type: 'paragraph',
          content: 'The cigar industry collapsed after World War II — machines replaced hand-rolling, cigarettes replaced cigars, Cuba became inaccessible. Ybor City emptied and deteriorated, the beautiful brick factories abandoned, the social clubs shuttered. Urban renewal threatened to bulldoze what remained. But the neighborhood survived, barely, and has been reborn as an entertainment district, the old buildings now housing clubs and restaurants, the brick streets carrying bachelor parties rather than cigar workers. The ghosts are still there if you look for them.',
        },
        {
          id: 'ad1',
          type: 'ad',
        ...
        },
        {
          id: 'p5',
          type: 'paragraph',
          content: 'Tampa has experienced more booms and busts than most American cities. The railroad arrived in 1884 and triggered the first. Henry Plant built a Moorish palace of a hotel that still stands, trying to make Tampa a destination resort. The cigar boom followed, then the Florida land boom of the 1920s that collapsed spectacularly. The postwar era brought military bases and suburbs and snowbirds. Each cycle left its mark on the built environment, the city a palimpsest of ambitions realized and abandoned.',
        },
        {
          id: 'p6',
          type: 'paragraph',
          content: 'The current boom is driven by the same forces transforming all of Florida: remote work refugees from expensive metros, retirees, and the low taxes and business-friendly regulation that draw companies south. Tampa has been discovered, and the discoverers are bidding up housing and filling the restaurants and complaining about the traffic. The city that was always overshadowed by Miami and Orlando is suddenly desirable on its own terms.',
        },
        {
          id: 'break2',
          type: 'break',
        ...
        },
        {
          id: 'p9',
          type: 'paragraph',
          content: 'The sports culture is recent and fervent. The Buccaneers spent their first two decades as a punchline—orange creamsicle jerseys, twenty-six consecutive losses to start their existence, the kind of franchise that made comedians rich. Then Jon Gruden arrived in 2002, and the defense destroyed the Raiders in the Super Bowl, and suddenly Tampa had something to celebrate. In 2020, Tom Brady showed up from New England at age forty-three, won another championship in his first season, and announced to the world that Tampa Bay was where greatness came to continue. The Lightning have been even more dominant: three Stanley Cups since 2004, back-to-back titles in 2020 and 2021, the kind of hockey dynasty that shouldn\'t exist in a city where natural ice is impossible. The Rays win ninety games annually with the lowest payroll in baseball, playing in the Tropicana Field that everyone agrees is terrible—a dome from 1990 that feels like a hangar, routinely half-empty, the subject of perpetual relocation rumors that never quite resolve. Tampa has become a championship city almost by accident, stacking trophies while still figuring out what that identity means.',
        },
        {
          id: 'p10',
          type: 'paragraph',
          content: 'To live in Tampa is to live in a city still becoming itself, still uncertain whether it\'s a regional hub or a national destination, still negotiating between its working-class port heritage and its aspirations to something more polished. The bay sparkles, the storms roll through, the ghosts of Ybor City smoke phantom cigars in the entertainment district, and the cranes keep building condos on the waterfront. Tampa has always been about hustle — cigars, shipping, whatever comes next — and the hustle continues.',
        },
      ],
    },
  }
