    ...
    'the-last-frontier-city': {
      ...
      blocks: [
        ...
        },
        {
          id: 'p3',
          type: 'paragraph',
          content: 'Anchorage barely existed before oil. The city was founded in 1914 as a construction camp for the Alaska Railroad—a tent town at Ship Creek where workers lived in conditions that would have embarrassed a mining camp. It grew slowly: 3,000 people by 1940, 43,000 by 1960, still a frontier outpost where the main streets turned to mud each spring. Then in 1968, Atlantic Richfield struck oil at Prudhoe Bay, the largest petroleum deposit in North American history, and everything changed. The pipeline came through in 1977, eight hundred miles of insulated steel carrying hot crude from the Arctic to Valdez. The money followed. BP and ConocoPhillips built gleaming headquarters downtown. Construction workers flooded in, making ten thousand dollars a month to lay pipe in temperatures that could freeze exposed skin in minutes. By 1980, Anchorage had nearly tripled in population, a boom town masquerading as a city, suddenly the financial capital of a state that had become obscenely rich.',
        },
        {
          id: 'quote1',
          type: 'pullquote',
        ...
        },
        {
          id: 'p4',
          type: 'paragraph',
          content: 'Every October, every man, woman, and child in Alaska receives a check from the state—their share of the oil wealth, somewhere between $1,000 and $3,000 depending on the year and the market and the political calculations of whoever\'s in Juneau. The Permanent Fund Dividend is the closest thing America has to universal basic income, funded by petroleum royalties invested in a sovereign wealth fund now worth over $70 billion. Families with four kids receive checks totaling ten thousand dollars or more. The stores run "PFD sales" each fall, knowing exactly when the money will hit accounts. The politics around the dividend are nuclear: touch it and your career ends. Alaska has no income tax, no state sales tax, and a government that lurches between surplus and deficit depending entirely on the price of Brent crude. When oil crashes, as it did in 2015, Anchorage goes quiet—layoffs at the oil companies, construction projects frozen, restaurants closing, the whole city holding its breath until the barrel price recovers.',
        },
        {
          id: 'ad1',
          type: 'ad',
        ...
        },
        {
          id: 'p5',
          type: 'paragraph',
          content: 'The light here is disorienting in ways that accumulate. In June, the sun sets around eleven p.m. and rises by four—less a sunset than a brief dimming, the sky shifting from blue to gold to salmon before starting the climb back up. Kids play in yards at midnight. Barbecues run until two a.m. People mow lawns after dinner because the light seems too precious to waste on sleep. The energy is manic, everyone outside all the time, trying to store sunlight like bears store fat. Then December arrives, and the equation inverts. The sun rises at ten-fifteen, traces a low arc just above the Chugach, and sets by three-thirty. By four p.m., the streets are dark. The SAD lamps come out—those ultraviolet boxes that simulate sunshine, lined up on office desks and kitchen tables. The drinking increases. The domestic violence calls increase. Suicide rates here are among the highest in the nation, and the winter is why. Living in Anchorage means accepting rhythms that human circadian systems never evolved for.',
        },
        {
          id: 'p6',
          type: 'paragraph',
          content: 'The population churns constantly. Military families rotate through Joint Base Elmendorf-Richardson on three-year tours—long enough to learn the hiking trails, not long enough to call it home. Oil workers fly two weeks on, two weeks off to the North Slope, technically Anchorage residents but present only half the time. Young people come for adventure—a summer fishing in Bristol Bay, a winter working ski patrol at Alyeska—and most leave when they want careers or partners or proximity to family in the Lower 48. The ones who stay are self-selecting: people who\'ve done the math on isolation and darkness and cold, weighed it against the PFD and the fishing and the particular freedom of a place where nobody cares what you do as long as you can handle the winters. Alaskans cultivate a toughness that can seem performative from outside—the bumper stickers that read "Palin: She Field Dressed a Moose"—but from inside feels like the accurate description of what surviving here requires.',
        },
        {
          id: 'break2',
          type: 'break',
        ...
        },
        {
          id: 'p10',
          type: 'paragraph',
          content: 'To live in Anchorage is to live inside a series of contradictions that never resolve. The city exists because of oil but is being unmade by what oil has done to the climate. It\'s a gateway to wilderness that looks like Anywhere, USA—the same Costco and Target and Applebee\'s you\'d find in Omaha or Phoenix. It\'s part of America but unreachable by road from the rest of America, an exclave connected to the Lower 48 only by plane or boat or a forty-hour drive through Canada. The Chugach rises behind the city, seven thousand feet of rock and ice, permanent and indifferent to whatever humans do at its feet. Cook Inlet stretches toward Redoubt and Iliamna, volcanoes that steam on the horizon. The moose wander through subdivisions each winter, eating ornamental shrubs, occasionally stomping dogs that get too close. And somehow three hundred thousand people have looked at all of this—the darkness, the isolation, the absurd cold, the strip malls surrounded by genuine wilderness—and decided that this improbable place, this contradiction of a city, is home.',
        },
      ],
    },
    'the-butcher-baker': {
      slug: 'the-butcher-baker',
      citySlug: 'anchorage',
