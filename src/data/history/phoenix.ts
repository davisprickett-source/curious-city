...
export const phoenix_history: Record<string, History> = {
    'the-air-conditioned-dream': {
      ...
      blocks: [
        ...
        },
        {
          id: 'p4',
          type: 'paragraph',
          content: 'But Phoenix remained small and marginal until air conditioning. The technology that made Florida livable made Arizona habitable, the swamp coolers of the 1930s giving way to refrigerated air in the 1950s, and suddenly summer was not an ordeal to be endured but a mild inconvenience to be ignored. The city exploded after World War II, servicemen who\'d trained at the airbases around Phoenix returning with families, developers building subdivisions in the desert, paving over creosote and saguaro, replacing native landscape with lawns and swimming pools and palm trees imported from California.',
        },
        {
          id: 'p5',
          type: 'paragraph',
        ...
        },
        {
          id: 'p12',
          type: 'paragraph',
          content: 'The downtown tried to revitalize, high-rises and the convention center and Chase Field where the Diamondbacks play baseball in air-conditioned comfort, the retractable roof closed all summer because outdoor baseball in Phoenix would be lethal. The arts district and Roosevelt Row offer galleries and restaurants and street art, the attempt to create urban culture in a city fundamentally suburban, the effort genuine but swimming against the current of a place designed for dispersal rather than density.',
        },
        {
          id: 'ad2',
          type: 'ad',
