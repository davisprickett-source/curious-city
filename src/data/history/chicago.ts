...
export const chicago_history: Record<string, History> = {
    'the-swamp-that-worked': {
      ...
      blocks: [
        ...
        },
        {
          id: 'p6',
          type: 'paragraph',
          content: 'The Loop is named for the elevated train that circles downtown, the \'L\' screeching around corners at twenty miles an hour, casting shadows on the streets below, the rattle and groan of century-old steel the city\'s constant background noise. The architecture here is world-class, and everyone knows it—tourists crane their necks at the Willis Tower (which everyone local still calls the Sears Tower, thirty years after the naming rights sold), and the river boat tours explain how the Chicago School invented the modern skyscraper because the fire had destroyed everything and there was nothing left to preserve, no historic character to protect, only the freedom to build up. The city invented the steel-frame high-rise and then exported it globally, along with the Prairie Style that Frank Lloyd Wright developed in Oak Park and Mies van der Rohe\'s glass-and-steel minimalism that shaped every corporate lobby built since 1960. Chicago made itself synonymous with a certain kind of modern urbanism—functional, democratic, built to human scale even when the buildings scrape clouds.',
        },
        {
          id: 'break2',
          type: 'break',
