...
export const salt_lake_city_history: Record<string, History> = {
    'zion-in-the-desert': {
      ...
      blocks: [
        ...
        },
        {
          id: 'quote1',
          type: 'pullquote',
          content: 'They needed somewhere no one else wanted, somewhere they could build Zion without interference. They found it in this bowl of desert between the Wasatch Mountains and the dead sea.',
        },
        {
          id: 'p4',
          type: 'paragraph',
        ...
        },
        {
          id: 'quote2',
          type: 'pullquote',
          content: 'To live in Salt Lake is to orient your life around the mountains — where you can see them from your window, how quickly you can reach them, what conditions await this weekend.',
        },
        {
          id: 'p8',
          type: 'paragraph',
