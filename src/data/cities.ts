        ...
        items: [
          {
            ...
            neighborhood: 'Downtown',
            yearsOpen: '1978–2021',
            description: 'The downtown clubhouse for legislators, lawyers, and power brokers, serving steaks, martinis, and backroom deals for over 40 years. The leather booths, dim lighting, and old-school service made it feel like a secret—even though everyone in Utah politics knew about it.',
            whyMissed: 'The sense that important conversations happened there, the ribeye, and the feeling that Salt Lake had at least one place that took itself seriously. It closed during the pandemic and never reopened.',
            communityVoice: '"More bills were negotiated at The New Yorker than at the State Capitol." — Salt Lake Tribune',
            lastAddress: '60 W Market St, Salt Lake City',
          ...
          },
          {
            ...
            yearsOpen: '1999–2022',
            description: 'The all-ages DIY venue in a backyard that launched local bands and hosted touring acts before they were famous. The Killers, Imagine Dragons, and Neon Trees all played there early. For 23 years, it proved Salt Lake had a music scene—you just had to know where to look.',
            whyMissed: 'The intimacy, the all-ages shows for kids who had nowhere else to go, and the scrappiness that made national bands want to play a backyard in Utah. It closed in 2022, but the spirit lives on.',
            communityVoice: '"Kilby Court was where Salt Lake proved it had something to say." — City Weekly',
            lastAddress: '741 S Kilby Ct, Salt Lake City',
            source: 'Salt Lake Tribune, City Weekly',
          },
          {
            id: 'slc-lost-3',
            type: 'lost-and-loved',
            ...
            neighborhood: 'Sugar House',
            yearsOpen: '1999–2018',
            description: 'The neighborhood pub with trivia nights, live music, and a patio where Sugar House gathered. In a state with complicated drinking laws, it was refreshingly unpretentious—just a place to have a beer and talk. It closed when the building was sold for redevelopment.',
            whyMissed: 'The trivia nights, the regulars who felt like family, and the reminder that Salt Lake could have normal neighborhood bars if it tried. The patio on summer nights felt like the city loosening its collar.',
            communityVoice: '"Cheers to You was the bar Utah deserved." — Salt Lake Magazine',
            lastAddress: '1450 S 1100 E, Salt Lake City',
            source: 'Salt Lake Tribune, Gastronomic SLC',
          },
          {
            id: 'slc-lost-ad-1',
            type: 'ad',
          ...
          },
          {
            ...
            type: 'lost-and-loved',
            category: 'restaurant',
            name: 'Lamb\'s Grill Cafe',
            neighborhood: 'Downtown',
            yearsOpen: '1919–2020',
            description: 'The oldest continuously operating restaurant in Utah, serving Greek-American diner food from the same lunch counter for 101 years. The rice pudding, the vinyl booths, the Grecian artwork—it was a time capsule. Presidents, governors, and construction workers all sat at the same counter.',
            whyMissed: 'The continuity, the sense that some things don\'t change, and the rice pudding that people drove across the state for. When it closed in 2020, Salt Lake lost a century of history.',
            communityVoice: '"Lamb\'s was the closest thing Salt Lake had to sacred ground outside a temple." — Deseret News',
            lastAddress: '169 S Main St, Salt Lake City',
            source: 'Salt Lake Tribune, Deseret News',
          },
          {
            id: 'slc-lost-5',
            ...
            neighborhood: 'Sugar House',
            yearsOpen: '1995–2019',
            description: 'The independent coffee shop with overstuffed chairs, local art, and a patio where Sugar House lingered. It was where students studied, writers worked, and neighbors caught up. The coffee was strong, the vibe relaxed, and it felt like the anti-Starbucks.',
            whyMissed: 'The independent spirit, the sense that coffee shops could be gathering places, and the patio that felt like Sugar House\'s living room. It closed when the lease wasn\'t renewed.',
            communityVoice: '"The Coffee Garden was where we went to feel like ourselves." — City Weekly',
            lastAddress: '878 E 900 S, Salt Lake City',
            source: 'Salt Lake Tribune, City Weekly',
          },
          {
            id: 'slc-lost-6',
            ...
            yearsOpen: '2006–2021',
            description: 'The Middle Eastern cafe in a strip mall that served the best falafel, shawarma, and hummus in Utah. It was family-run, affordable, and authentic—the kind of place where regulars knew to order off-menu. When it closed, the Middle Eastern community lost a gathering place.',
            whyMissed: 'The family hospitality, the lamb shawarma plate, and the sense that you were eating someone\'s grandmother\'s recipes. It was proof that great food doesn\'t need a fancy address.',
            communityVoice: '"Mazza fed both your body and your homesickness." — Salt Lake Magazine',
            lastAddress: '1515 S State St, South Salt Lake',
            source: 'Gastronomic SLC, Salt Lake Magazine',
          },
          {
            id: 'slc-lost-ad-2',
            type: 'ad',
          ...
          },
          {
            ...
            type: 'lost-and-loved',
            category: 'bookstore',
            name: 'Sam Weller\'s Zion Bookstore',
            neighborhood: 'Downtown',
            yearsOpen: '1929–2012',
            description: 'The three-story independent bookstore with creaky floors, rare books, and a sense that you could get lost for hours. For 83 years, it was Salt Lake\'s intellectual heart. It survived the Depression, but not Amazon. A smaller version reopened in Trolley Square, but it wasn\'t the same.',
            whyMissed: 'The browsing, the rare book room, and the feeling that downtown had a soul. When the original location closed, Salt Lake lost a landmark.',
            communityVoice: '"Sam Weller\'s was where Salt Lake went to think." — Salt Lake Tribune',
            lastAddress: '254 S Main St, Salt Lake City',
            source: 'Salt Lake Tribune, Publisher\'s Weekly',
          },
          {
            id: 'slc-lost-8',
            type: 'lost-and-loved',
            ...
            neighborhood: 'Downtown',
            yearsOpen: '1982–2015',
            description: 'The gay bar in a Victorian house that was a haven for decades, with drag shows, disco nights, and a sense of community in a conservative state. The wooden floors, the outdoor patio, the unabashed queerness—it was a rare space where you could be yourself.',
            whyMissed: 'The safety, the chosen family, and the drag shows that felt both campy and essential. When it closed, Salt Lake\'s LGBTQ community lost a historic gathering place.',
            communityVoice: '"The Republican was where we learned we weren\'t alone." — QSaltLake',
            lastAddress: '117 W Pierpont Ave, Salt Lake City',
            source: 'QSaltLake, Salt Lake Tribune',
          },
          {
            id: 'slc-lost-9',
            type: 'lost-and-loved',
            category: 'shop',
            name: 'Cosmic Aeroplane Books',
            neighborhood: 'Sugar House',
            yearsOpen: '1976–2016',
            description: 'The new age bookstore and spiritual supply shop with tarot cards, incense, and a vibe that felt distinctly un-Mormon. For 40 years, it was where Salt Lake\'s spiritual seekers gathered. The cats, the crystals, the sense that anything was possible—it was a portal to other ways of thinking.',
            whyMissed: 'The acceptance, the incense smell, and the reminder that Salt Lake contained multitudes. It was proof that counterculture could survive in Zion.',
            communityVoice: '"Cosmic Aeroplane was where Salt Lake\'s weirdos found each other." — City Weekly',
            lastAddress: '2100 S 700 E, Salt Lake City',
            source: 'City Weekly, Salt Lake Tribune',
          },
        ],
      },
    ],
        ...
        items: [
          {
            ...
            type: 'lost-and-loved',
            category: 'restaurant',
            name: 'The Broadmoor Tavern',
            neighborhood: 'Broadmoor',
            yearsOpen: '1961–2015',
            description: 'The dark-paneled tavern adjacent to The Broadmoor resort where locals went for prime rib, martinis, and the feeling of old Colorado Springs luxury. It had the clubby atmosphere of a 1960s steakhouse—red leather, dim lighting, and waiters who remembered your order. For 54 years, it was where the city celebrated.',
            whyMissed: 'The prime rib cart, the old-school service, and the sense that Colorado Springs had at least one place that felt like money without trying too hard. When The Broadmoor closed it for renovations, it never reopened the same way.',
            communityVoice: '"The Tavern was where Colorado Springs went to feel sophisticated." — The Gazette',
            lastAddress: '1 Lake Ave, Colorado Springs',
            source: 'The Gazette, Colorado Springs Independent',
          },
          {
            id: 'cos-lost-2',
            type: 'lost-and-loved',
            category: 'cafe',
            name: 'Pikes Perk Coffee',
            neighborhood: 'Old Colorado City',
            yearsOpen: '1994–2020',
            description: 'The independent coffee shop in a Victorian house in Old Colorado City, with creaky floors, mismatched furniture, and a progressive vibe that felt delightfully out of place. For 26 years, it was where artists, activists, and the alternative crowd gathered—a counterweight to Focus on the Family.',
            whyMissed: 'The sense of sanctuary, the open mic nights, and the reminder that Colorado Springs contained more than megachurches and military bases. It closed during the pandemic.',
            communityVoice: '"Pikes Perk was where Colorado Springs\'s other half went to breathe." — Colorado Springs Independent',
            lastAddress: '2416 W Colorado Ave, Colorado Springs',
            source: 'Colorado Springs Independent, The Gazette',
          },
          {
            id: 'cos-lost-3',
            type: 'lost-and-loved',
            ...
            neighborhood: 'Downtown',
            yearsOpen: '1950–2009',
            description: 'The Greek diner downtown with laminated menus, bottomless coffee, and gyros that tasted like someone\'s grandmother made them. For 59 years, it fed construction workers, office employees, and anyone who wanted an honest meal. The baklava was famous. The prices stayed reasonable until the end.',
            whyMissed: 'The affordability, the gyro plate, and the sense that downtown still had places for working people. When it closed, Colorado Springs lost a piece of its unpretentious past.',
            communityVoice: '"Jimmy\'s was the last place downtown where you could eat for under $10 and feel full." — The Gazette',
            lastAddress: '112 N Tejon St, Colorado Springs',
            source: 'The Gazette, KRDO',
          },
          {
            id: 'cos-lost-ad-1',
            type: 'ad',
          ...
          },
          {
            ...
            neighborhood: 'Downtown',
            yearsOpen: '2004–2019',
            description: 'The all-ages music venue and arts space that brought punk, indie, and hip-hop to downtown Colorado Springs. The walls were covered in band stickers, the floor was sticky, and the shows were loud. For 15 years, it proved Colorado Springs had a music scene beyond Christian rock.',
            whyMissed: 'The all-ages shows, the sense of community for kids who didn\'t fit elsewhere, and the commitment to keeping ticket prices low. It closed when the building was sold.',
            communityVoice: '"The Black Sheep gave Colorado Springs a cultural heartbeat." — Colorado Springs Independent',
            lastAddress: '2106 E Platte Ave, Colorado Springs',
            source: 'Colorado Springs Independent, The Gazette',
          },
          {
            id: 'cos-lost-5',
            ...
            neighborhood: 'Downtown',
            yearsOpen: '1996–2023',
            description: 'The Irish pub on Tejon Street with live music nightly, Fish & Chips Fridays, and a running club that took over downtown every Tuesday. For 27 years, it was where Colorado Springs gathered—military, civilians, runners, and regulars. When it closed unexpectedly in 2023, the city mourned.',
            whyMissed: 'The Tuesday night running club with hundreds of participants, the live music, and the sense that Jack Quinn\'s belonged to everyone. It was the rare place where all versions of Colorado Springs coexisted.',
            communityVoice: '"Jack Quinn\'s was the living room of Colorado Springs." — The Gazette',
            lastAddress: '21 S Tejon St, Colorado Springs',
            source: 'The Gazette, Colorado Springs Independent',
          },
          {
            id: 'cos-lost-6',
            type: 'lost-and-loved',
            category: 'bookstore',
            name: 'The Chinook Bookshop',
            neighborhood: 'Old North End',
            yearsOpen: '1959–2010',
            description: 'The independent bookstore on North Tejon with signed first editions, knowledgeable staff, and author readings that brought literary culture to Colorado Springs. For 51 years, it competed with chains by being smarter and more personal. It closed when the owners retired.',
            whyMissed: 'The staff recommendations, the signed books, and the feeling that reading was a culture, not just a transaction. When Chinook closed, Colorado Springs lost its literary soul.',
            communityVoice: '"Chinook Bookshop made Colorado Springs feel literate." — Pikes Peak Bulletin',
            lastAddress: '210 N Tejon St, Colorado Springs',
            source: 'The Gazette, Publisher\'s Weekly',
          },
          {
            id: 'cos-lost-ad-2',
            type: 'ad',
          ...
          },
          {
            ...
            type: 'lost-and-loved',
            category: 'restaurant',
            name: 'La Baguette French Bakery',
            neighborhood: 'Fillmore',
            yearsOpen: '1985–2018',
            description: 'The French bakery run by actual French bakers, with croissants that shattered when you bit them, quiche for lunch, and macarons in the case. For 33 years, it brought European authenticity to a strip mall on Fillmore Street. The owners retired, and no one could replicate it.',
            whyMissed: 'The croissants, the authenticity, and the reminder that good food could exist anywhere—even next to a tire shop. It was proof that Colorado Springs valued craft.',
            communityVoice: '"La Baguette\'s croissants were the best thing in Colorado Springs." — Colorado Springs Independent',
            lastAddress: '2417 E Pikes Peak Ave, Colorado Springs',
            source: 'The Gazette, Colorado Springs Independent',
          },
          {
            id: 'cos-lost-8',
            ...
            neighborhood: 'Old Colorado City',
            yearsOpen: '1980–2016',
            description: 'The gift shop and art gallery selling handmade crafts, local art, and quirky gifts in Old Colorado City. The name came from a Dr. Seuss creature, and the vibe matched—playful, colorful, and unapologetically weird. For 36 years, it was where Colorado Springs bought birthday presents and supported local artists.',
            whyMissed: 'The local crafts, the sense of whimsy, and the commitment to supporting artists over mass production. It closed when the owners retired.',
            communityVoice: '"The Wooglins was where Colorado Springs\'s creative side lived." — Colorado Springs Independent',
            lastAddress: '2406 W Colorado Ave, Colorado Springs',
            source: 'Colorado Springs Independent, The Gazette',
          },
        ],
      },
