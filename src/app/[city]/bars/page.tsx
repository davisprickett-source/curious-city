...
import { ShareLinks, MapThumbnail, ImageCarousel } from '@/components'
...
export default async function CityBarsPage({ params }: PageProps) {
  ...
  const bars = await getCityBestOf(slug, 'bars')
    ...
    <>
      ...
      {city.slug === 'minneapolis' && (
        <div className="relative h-[500px] md:h-[600px] border-b border-neutral-200">
          <img
            src="/global-banners/bar-banner.png"
            alt="Best Bars in Minneapolis"
          ...
          <div className="relative container-page h-full flex flex-col justify-center items-start py-20">
            ...
            <div className="absolute top-6 right-6 md:top-8 md:right-8">
              <ShareLinks title={`Best Bars in ${city.name} | Curious City`} variant="banner" />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="container-page section-spacing">
            ...
            <div className="mb-8">
              <div className="flex items-start justify-between gap-4 mb-2">
                ...
                <div className="hidden sm:block flex-shrink-0">
                  <ShareLinks title={`Best Bars in ${city.name} | Curious City`} variant="compact" />
                </div>
              </div>
          ...
          {bars.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-neutral-500 mb-2">No bar recommendations yet for {city.name}.</p>
