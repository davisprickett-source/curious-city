...
export default function TermsPage() {
  return (
    <>
      ...
      <main className="flex-1">
        <div className="container-page section-spacing">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-8">
              <ShareButton title="Terms of Service | The Curious City" url="https://thecurious.city/terms" />
            </div>
      ...
      {/* End of Terms Page Flow - Share, Subscribe, Feedback */}
      <div className="container-page py-12 space-y-8">
        ...
        <div>
          ...
          <p className="text-neutral-700">
            ...
            <Link
              href={`mailto:hello@thecurious.city?subject=Feedback on Terms of Service Page`}
